...
import {DevicesEnum} from '../../constant/enum.ts';
...
//  const Bluetooth = ({route}) => {
//   const [selectedValue, setSelectedValue] = React.useState(DevicesEnum.net);
